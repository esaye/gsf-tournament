...
class TournamentManager:
    ...
    def test_website_upload(self):
        ...
        try:
            ...
            ], capture_output=True, text=True, cwd=self.tournament_dir)
    ...
    def backup_tournament(self):
        ...
        backup_dir = f"/home/ebrimasaye/TSH/backups/GSF_Prelims_WorldCup2025_{timestamp}"
        
        os.makedirs(backup_dir, exist_ok=True)
        
        # Copy tournament files
        import shutil
        shutil.copytree(self.tournament_dir, f"{backup_dir}/tournament", dirs_exist_ok=True)
