...
package TSH::Command::LowCombined;
...
TSH::Command::LowCombined - implement the C<tsh> LowCombined command

=head1 SYNOPSIS

  my $command = new TSH::Command::LowCombined;
...
TSH::Command::LowCombined is a subclass of TSH::Command.
...
sub Run ($$@) { 
  ...
  my $setupp = $this->SetupReport(
    'comparator' => sub ($$) { $_[0][0]+$_[0][1] <=> $_[1][0]+$_[1][1] }, # small totals first
    'dp' => $dp,
