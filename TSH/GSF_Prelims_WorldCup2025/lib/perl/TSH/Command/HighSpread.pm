...
package TSH::Command::HighSpread;
...
TSH::Command::HighSpread - implement the C<tsh> HighSpread command

=head1 SYNOPSIS

  my $command = new TSH::Command::HighSpread;
...
TSH::Command::HighSpread is a subclass of TSH::Command.
...
sub Run ($$@) { 
  ...
  my $setupp = $this->SetupReport(
    'comparator' => sub ($$) { $_[1][0]-$_[1][1] <=> $_[0][0]-$_[0][1] }, # big spreads first
    'dp' => $dp,
