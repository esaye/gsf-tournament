...
TSH::ParseArgs::Repeats - handle a command-line argument that should be a number of allowable repeats in a pairing algorithm

=head1 SYNOPSIS

  my $parser = new TSH::ParseArgs::Repeats;
...
sub initialise ($) {
  my $this = shift;
  $this->Minimum(0);
  $this->Description('a number of repeats allowed');
  return $this;
  }

=item $parserp = new ParserArgs::Repeats
