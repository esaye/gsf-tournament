...
package TSH::ParseArgs::BasedOnRound;
...
TSH::ParseArgs::BasedOnRound - handle a command-line argument that should be a tournament round number

=head1 SYNOPSIS

  my $parser = new TSH::ParseArgs::BasedOnRound;
...
sub initialise ($) {
  my $this = shift;
  $this->Minimum(0);
  $this->Description('a round number');
  return $this;
  }

=item $parserp = new ParserArgs::BasedOnRound
