...
TSH::ParseArgs::Rank- handle a command-line argument that should be a standings rank

=head1 SYNOPSIS

  my $parser = new TSH::ParseArgs::Rank;
...
sub initialise ($) {
  my $this = shift;
  $this->Minimum(1);
  $this->Description("a player rank number");
  return $this;
  }

=item $parserp = new ParserArgs::Rank
