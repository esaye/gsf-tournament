...
package TSH::ParseArgs::DebugLevel;
...
TSH::ParseArgs::DebugLevel - handle a command-line argument that should be a debug level

=head1 SYNOPSIS

  my $parser = new TSH::ParseArgs::DebugLevel;
...
sub initialise ($) {
  ...
  $this->Minimum(0);
  $this->Maximum(1);
  $this->Description('a debug level');
  return $this;
  }

=item $parserp = new ParserArgs::DebugLevel
