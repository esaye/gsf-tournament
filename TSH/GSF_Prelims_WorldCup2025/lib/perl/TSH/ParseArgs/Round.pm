...
TSH::ParseArgs::Round - handle a command-line argument that should be a tournament round number

=head1 SYNOPSIS

  my $parser = new TSH::ParseArgs::Round;
