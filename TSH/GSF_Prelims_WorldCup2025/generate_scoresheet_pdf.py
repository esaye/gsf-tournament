...
def generate_scoresheet_pdf():
    ...
    methods = [
        ...
        ["wkhtmltopdf", "--page-size", "A4", "--margin-top", "0.5in", 
         ...
         "--print-media-type", str(html_file), str(pdf_file)],
        
        # Method 2: chromium headless
        ["chromium-browser", "--headless", "--disable-gpu", "--print-to-pdf=" + str(pdf_file),
         "--print-to-pdf-no-header", str(html_file)],
        
        # Method 3: chrome headless
        ["google-chrome", "--headless", "--disable-gpu", "--print-to-pdf=" + str(pdf_file),
         "--print-to-pdf-no-header", str(html_file)]
    ]
